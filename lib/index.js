...
var _immutableTransform = require("./immutableTransform");
...
var extendConfig = function extendConfig(config) {
  ...
  if (!config.skipImmutableTransform) {
    transforms = [].concat(_toConsumableArray(incomingTransforms), [(0, _immutableTransform2.default)({ records: records })]);
  }
